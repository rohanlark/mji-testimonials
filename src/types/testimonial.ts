...
/** Layout default: light or dark only (accent themes are per-card). */
export const GLOBAL_CARD_THEME_IDS = ['light', 'dark'] as const;
export type GlobalCardThemeId = (typeof GLOBAL_CARD_THEME_IDS)[number];
